    ...
    <p class="text-gray-200 text-base leading-relaxed text-justify"><?php echo nl2br(e($currentChapter->content)); ?></p>
        ...
        <!--[if BLOCK]><![endif]--><?php if($question && !$isGameEnd && !$showFeedback): ?>
            <div class="mt-6 p-4 border border-gray-700 rounded-lg bg-gray-800">
                <h3 class="text-xl font-semibold mb-3 text-justify"><?php echo e($question->text); ?></h3>
...
<?php /**PATH C:\Users\lugar\Desktop\digital-detective\digital-detective\resources\views/livewire/play-story.blade.php ENDPATH**/ ?>