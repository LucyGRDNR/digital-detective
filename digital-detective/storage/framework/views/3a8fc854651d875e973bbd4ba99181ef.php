...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>">
    ...
    <head>
        ...
        <title><?php echo e(__('create-edit.edit_story')); ?>: <?php echo e($story->name); ?> - <?php echo e(__('create-edit.digital_detective')); ?></title>

        <?php echo app('Illuminate\Foundation\Vite')(['resources/css/app.css', 'resources/js/app.js', 'resources/js/edit.js']); ?>
    ...
    <body class="bg-[url('/storage/app/public/images/download.png')] bg-repeat bg-center text-white min-h-screen">
        ...
        <main class="px-6">
            <form id="story-edit-form" method="POST" action="<?php echo e(route('stories.update', $story->id)); ?>"
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <textarea id="story-description" name="description" rows="3"
                                class="story-input border border-gray-300 p-2 rounded-md w-full focus:ring-purple-500 focus:border-purple-500 text-gray-900"
                                ><?php echo e(old('description', $story->description)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div id="current-story-image-preview" class="mt-4 <?php echo e($story->image_path ? '' : 'hidden'); ?>">
                            <img id="story-image-tag" src="<?php echo e($story->image_path ? asset('storage/' . $story->image_path) : ''); ?>" class="max-w-full h-auto rounded-md" alt="<?php echo e(__('create-edit.current_story_image')); ?>">
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" id="story-place" name="place"
                                class="story-input border border-gray-300 p-2 rounded-md w-full focus:ring-purple-500 focus:border-purple-500 text-gray-900"
                                value="<?php echo e(old('place', $story->place)); ?>">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="text" id="place-gps" name="place_GPS"
                                class="story-input border border-gray-300 p-2 rounded-md w-full focus:ring-purple-500 focus:border-purple-500 text-gray-900"
                                value="<?php echo e(old('place_GPS', $story->place_GPS)); ?>">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <input type="number" id="story-distance" name="distance" min="0"
                                    value="<?php echo e(old('distance', $story->distance)); ?>" required
                                    class="story-input border border-gray-300 p-2 rounded-md w-full focus:ring-purple-500 focus:border-purple-500 text-gray-900">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <input type="number" id="story-time" name="time" min="0"
                                    value="<?php echo e(old('time', $story->time)); ?>" required
                                    class="story-input border border-gray-300 p-2 rounded-md w-full focus:ring-purple-500 focus:border-purple-500 text-gray-900">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="flex justify-between items-center mt-8">
                    ...
                    <div class="flex space-x-4">
                        <button type="submit" form="story-delete-form"
                            ...
                            onclick="return confirm('<?php echo e(__('create-edit.confirm_delete_story')); ?>');">
                            <i class="fas fa-trash-alt mr-2"></i> <?php echo e(__('create-edit.delete_story_button')); ?>
                        ...
                        <button type="submit" onclick="prepareAndSubmitStory(event)"
                            ...
                            <?php echo e(__('create-edit.save_changes_button')); ?>
            ...
            <form id="story-delete-form" method="POST" action="<?php echo e(route('stories.destroy', $story->id)); ?>" class="hidden">
                <?php echo csrf_field(); ?>
        ...
        <script>
            window.initialStoryData = <?php echo json_encode($story, 15, 512) ?>;
            window.baseImageUrl = "<?php echo e(Storage::url('')); ?>";
        </script>
        <script>
...
<?php /**PATH C:\Users\Lucy\Downloads\digital-detective\digital-detective\resources\views/edit.blade.php ENDPATH**/ ?>