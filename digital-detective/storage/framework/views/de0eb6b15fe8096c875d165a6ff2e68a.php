...
<body class="bg-[url('/storage/app/public/images/download.png')] bg-no-repeat bg-cover bg-fixed text-white min-h-screen relative">
    ...
    <main class="px-6 py-6">
        <div x-data="{
            ...
            filterDistance: '',
            filterTime: '',
            stories: <?php echo \Illuminate\Support\Js::from($stories)->toHtml() ?>,
            ...
            <form @submit.prevent class="flex flex-col md:flex-row gap-4 w-full items-center">
                        ...
                        <button @click="distanceDropdownOpen = !distanceDropdownOpen" type="button"
                            ...
                            <span>
                                <template x-if="filterDistance === ''">
                                    <span><?php echo e(__('welcome-show.distance')); ?></span>
                                </template>
                        ...
                        <button @click="timeDropdownOpen = !timeDropdownOpen" type="button"
                            ...
                            <span>
                                <template x-if="filterTime === ''">
                                    <span><?php echo e(__('welcome-show.time')); ?></span>
                                </template>
                ...
                <button type="button" @click="clearFilters"
                    ...
                    <i class="fas fa-times-circle mr-1"></i> <?php echo e(__('welcome-show.clear')); ?>
...
</html><?php /**PATH C:\Users\lugar\Desktop\digital-detective\digital-detective\resources\views/welcome.blade.php ENDPATH**/ ?>