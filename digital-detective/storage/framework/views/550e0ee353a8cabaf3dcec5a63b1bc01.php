...
<body class="bg-[url('/storage/app/public/images/download.png')] bg-repeat bg-center text-white min-h-screen">
    ...
    <main class="px-4 py-10">
        <div class="max-w-3xl mx-auto rounded-lg bg-gray-900 bg-opacity-80 p-6 shadow-md border border-gray-700">
            ...
            <p class="text-gray-300 mb-4 text-sm md:text-base"><?php echo e($story->description); ?></p>

            <div class="mb-6 text-sm md:text-base text-gray-400">
                <p class="mb-1 text-md text-gray-300"><?php echo e(__('welcome-show.location')); ?>: <?php echo e($story->place); ?></p>
                <p class="mb-1 text-md text-gray-300"><?php echo e(__('welcome-show.time')); ?>: <?php echo e($story->time); ?> <?php echo e(__('welcome-show.minutes')); ?></p>
                <p class="mb-4 text-md text-gray-300"><?php echo e(__('welcome-show.distance')); ?>: <?php echo e($story->distance); ?> <?php echo e(__('welcome-show.kilometers')); ?></p>
            </div>
...
</html><?php /**PATH C:\Users\Lucy\Downloads\digital-detective\digital-detective\resources\views/show.blade.php ENDPATH**/ ?>