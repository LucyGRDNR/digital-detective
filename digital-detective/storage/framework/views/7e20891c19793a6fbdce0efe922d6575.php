        ...
        <div class="fixed inset-y-0 right-0 w-64 bg-gray-900 shadow-lg transform translate-x-full transition-transform ease-in-out duration-300 z-50"
            ...
            <div class="p-4 pt-10">
                ...
                <div class="flex flex-col space-y-4">
                    ...
                    <?php if(auth()->guard()->guest()): ?>
                        <a href="<?php echo e(route('login')); ?>" class="text-blue-400 hover:underline text-lg transition duration-200 ease-in-out"><?php echo e(__('welcome-show.login_link')); ?></a>
                        <a href="<?php echo e(route('register')); ?>" class="rounded bg-blue-600 px-4 py-2 text-white hover:bg-blue-700 text-lg transition duration-200 ease-in-out"><?php echo e(__('welcome-show.register_link')); ?></a>
                    <?php endif; ?>
                </div>
            </div>
        </div>
</nav><?php /**PATH C:\Users\Lucy\Downloads\digital-detective\digital-detective\resources\views/partials/_navbar.blade.php ENDPATH**/ ?>