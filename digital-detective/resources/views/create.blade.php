...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <head>
        ...
        <title>{{ __('create-edit.create_story') }} - {{ __('create-edit.digital_detective') }}</title>

        @vite(['resources/css/app.css', 'resources/js/app.js', 'resources/js/create.js'])
    ...
    <body class="bg-[url('/storage/app/public/images/download.png')] bg-repeat bg-center text-white min-h-screen">
        ...
        <main class="px-6">
            <form id="story-creation-form" method="POST" action="{{ route('stories.store') }}" enctype="multipart/form-data" class="max-w-4xl mx-auto p-6 bg-white shadow-md rounded-lg my-8">
                @csrf
                ...
                <div class="mb-6 p-4 border rounded-lg bg-gray-50">
                    ...
                    <div class="space-y-4">
                        ...
                        <div id="current-story-image-preview" class="mt-4">
                            <img id="story-image-tag" src="data:image/gif;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs=" class="max-w-full h-auto rounded-md" alt="{{ __('create-edit.current_story_image') }}">
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <input type="number" id="story-distance" name="distance" min="0" value="{{ old('distance', 0) }}" required
                                        class="story-input border border-gray-300 p-2 rounded-md w-full focus:ring-blue-500 focus:border-blue-500 text-gray-700">
                                ...
                                <div>
                                    ...
                                    <input type="number" id="story-time" name="time" min="0" value="{{ old('time', 0) }}" required
                                        class="story-input border border-gray-300 p-2 rounded-md w-full focus:ring-blue-500 focus:border-blue-500 text-gray-700">
                ...
                <div class="flex justify-between items-center mt-8">
                    ...
                    <div class="flex space-x-4">
                        <button type="submit" onclick="prepareAndSubmitStory(event)"
                            ...
                            {{ __('create-edit.save_story_button') }}
                        </button>
                    </div>
                </div>
            </form>
            ...
            <template id="chapter-template">
                <div class="border rounded-lg p-6 space-y-4 chapter-block relative bg-white shadow-sm">
                    ...
                    {{-- Stores a temporary unique ID for the chapter --}}
                    ...
                    {{-- Question Details Section (conditionally hidden by JS) --}}
